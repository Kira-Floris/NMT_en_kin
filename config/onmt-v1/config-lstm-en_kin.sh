# preprocessing data
onmt_preprocess -train_src NMT_en_kin/data/train/train.en -train_tgt NMT_en_kin/data/train/train.rw -valid_src NMT_en_kin/data/dev/dev.en -valid_tgt NMT_en_kin/data/dev/dev.rw -save_data NMT_en_kin/data/vocab/onmt-v1/en_kin
...
# calculating score
sacrebleu NMT_en_kin/data/test/test.rw < NMT_en_kin/temp/pred_kin.txt