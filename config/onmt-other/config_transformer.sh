...
# test
onmt_translate -model NMT_en_kin/models/onmt_others/en_kin_model_transformer/en_kin_model_2000.pt -src NMT_en_kin/data/test/test-en.txt -output NMT_en_kin/temp/pred_rw.txt -gpu 0 -verbose
